...
@Getter
@Slf4j
public class VgsConfiguration extends AbstractOperatorConfiguration {
  static final String CONFIG_PREFIX = "extw.operator.vgs";
  ...
  public Configuration configure(Config config) {
    ...
    hashSecret =
        value(CONFIG_PREFIX, "hash-secret", String.class, UUID.randomUUID().toString(), config);
